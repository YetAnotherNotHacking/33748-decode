...
public class ShooterConstants {
    ...
    public static double CYCLE_D_MIDWAY_TARGET_RPM = 4290.0;
    ...
    public static long CYCLE_C_FEEDER_PULSE_PAUSE_TIME_MS = 0; // opposition
    public static long CYCLE_D_FEEDER_PULSE_PAUSE_TIME_MS = 0; // midway
