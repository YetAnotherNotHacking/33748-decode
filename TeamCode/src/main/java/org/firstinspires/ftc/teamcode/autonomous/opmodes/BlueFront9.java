...
@Autonomous(name = "Blue Front 9 Ball", preselectTeleOp = "Blue Goal TeleOp")
public class BlueFront9 extends BaseAutoOpMode {
    @Override
    protected void runAutonomous() {
        ...
        controller.pathTo(AutonomousPoints.Blue.Front.INTAKE_MID_2);
